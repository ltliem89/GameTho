...
export function getInitialQuests(): Quest[] {
  return [
    ...
    },
    {
      ...
      descVi: 'Hoàn thành ít nhất 2 nhiệm vụ giải cứu muôn loài và dọn sạch rừng xanh.',
      icon: '🛡️',
      category: 'nature',
      targetCount: 2,
      currentCount: 0,
...
export function getInitialAchievements(): Achievement[] {
  return [
    ...
    {
      id: 'ach_eco_savior',
      titleVi: 'Hộ Thần Môi Trường',
      descVi: 'Giải cứu Bé Nhím gai, dọn rác suối, dập than hồng và cứu tổ chim non.',
      icon: '🌍',
      unlocked: false,
      category: 'nature',
      rewardCarrots: 60,
...
export function getInitialRescues(): EnvironmentalRescue[] {
  return [
    {
      id: 'rescue_hedgehog_thorns',
      type: 'hedgehog_thorns',
      titleVi: 'Giải Cứu Bé Nhím Kẹt Gai',
      victimNameVi: 'Bé Nhím Gai Spiky',
      x: 1380,
      y: 1150,
      width: 70,
      height: 70,
      status: 'in_distress',
      progress: 0,
      rescueActionVi: 'Gỡ Bụi Gai 🦔',
      icon: '🦔',
      dialogueBefore: 'Huhu bạn Thỏ ơi! Chân tớ bị cành gai sắc nhọn quấn chặt không sao rút ra được, tớ sợ quá!',
      dialogueSaved: 'Ôi bạn Thỏ thật dũng cảm và khéo léo! Bụi gai đã tan rồi, tớ tặng bạn Cỏ 4 Lá và Cà Rốt nhé!',
      rewardCarrots: 35,
      rewardXp: 85,
      rewardItemVi: 'Cỏ 4 Lá May Mắn 🍀',
      ecoTipVi: 'Bảo vệ các loài động vật hoang dã nhỏ bé và giữ gìn lối đi an toàn cho muôn thú trong rừng!',
    },
    {
      id: 'rescue_stream_trash',
      type: 'stream_trash',
      titleVi: 'Dọn Rác Thải Suối Pha Lê',
      victimNameVi: 'Dòng Suối & Đàn Cá Con',
      x: 2350,
      y: 1480,
      width: 80,
      height: 60,
      status: 'in_distress',
      progress: 0,
      rescueActionVi: 'Dọn Rác Suối 🌊',
      icon: '🥤',
      dialogueBefore: 'Chai nhựa và túi ni-lông trôi dạt ứ đọng làm nghẽn dòng nước trong vắt, cá nhỏ kêu cứu!',
      dialogueSaved: 'Dòng suối đã trong veo lấp lánh trở lại! Đàn cá quẫy đuôi nhảy múa cảm ơn bạn Thỏ!',
      rewardCarrots: 40,
      rewardXp: 95,
      rewardItemVi: 'Giọt Nước Pha Lê 💎',
      ecoTipVi: 'Tuyệt đối không vứt rác thải nhựa xuống sông suối để bảo vệ nguồn nước ngọt cho sự sống muôn loài!',
    },
    {
      id: 'rescue_wildfire_ember',
      type: 'wildfire_ember',
      titleVi: 'Dập Tắt Tàn Lửa Bãi Cỏ',
      victimNameVi: 'Bãi Cỏ Khô Ven Rừng',
      x: 1980,
      y: 2180,
      width: 75,
      height: 65,
      status: 'in_distress',
      progress: 0,
      rescueActionVi: 'Dập Tắt Than Hồng 💧',
      icon: '🔥',
      dialogueBefore: 'Mồi than hồng cắm trại ai đó bỏ quên đang bốc khói mù mịt, sắp bén cháy lan cánh rừng!',
      dialogueSaved: 'Khói đen đã tắt ngấm và nở ra đóa hoa xanh thơm ngát! Cả cánh rừng đã được an toàn!',
      rewardCarrots: 45,
      rewardXp: 105,
      rewardItemVi: 'Hoa Ngũ Sắc Rừng 🌸',
      ecoTipVi: 'Luôn dập tắt hoàn toàn mọi mồi lửa khi đi dã ngoại để bảo vệ lá phổi xanh của Trái Đất!',
    },
    {
      id: 'rescue_fallen_nest',
      type: 'fallen_nest',
      titleVi: 'Cứu Tổ Chim Non Rơi Cành',
      victimNameVi: 'Tổ Chim Non Lông Vàng',
      x: 3480,
      y: 880,
      width: 70,
      height: 70,
      status: 'in_distress',
      progress: 0,
      rescueActionVi: 'Đưa Tổ Lên Cây 🪺',
      icon: '🪺',
      dialogueBefore: 'Gió bão làm rơi tổ chim xuống đất, hai chú chim non chíp chíp rét run đang gặp nguy hiểm!',
      dialogueSaved: 'Tổ chim đã được đặt ấm áp trên chạc cây cổ thụ! Chim mẹ bay về ríu rít bài ca tri ân!',
      rewardCarrots: 50,
      rewardXp: 120,
      rewardItemVi: 'Lông Vũ Ánh Sao ⭐',
      ecoTipVi: 'Yêu thương và che chở cho các tổ chim non, giữ trọn thanh âm trong trẻo của mẹ thiên nhiên!',
    },
  ];
}
...
export function generateInitialWorld(): {
  ...
  animals.push({
    id: 'animal_crocodile_river',
    type: 'crocodile',
    name: 'Crocodile',
    nameVi: 'Cá Sấu Bác Ba Thân Thiện',
    x: 2940,
    y: 1250,
    initialX: 2940,
    initialY: 1250,
    ...
    stateTimer: 0,
    dialogueVi: [
      'Gừ gừ~ Đừng sợ nhé bé thỏ! Bác Ba là cá sấu ăn cá suối và thích ngâm mình trong dòng nước mát!',
      'Nhìn đàn cá chép vàng và cá suối bơi lội tung tăng quanh bác kìa, đẹp tuyệt!',
      'Thỏ con nhớ đi qua 3 cây cầu gỗ bắc ngang suối nhé, nước suối ở đây sâu lắm đó!',
      'Bác Ba chúc bé thỏ tìm được thật nhiều cà rốt thơm ngon và khám phá trọn vẹn khu rừng!',
    ],
    dialogueTimer: 0,
  });

  animals.push({
    id: 'animal_crocodile_marsh',
    type: 'crocodile',
    name: 'Crocodile Marsh',
    nameVi: 'Bé Cá Sấu Đầm Lầy',
    x: 2680,
    y: 2180,
    initialX: 2680,
    initialY: 2180,
    ...
    stateTimer: 0,
    dialogueVi: [
      'Gừ gừ... Bé cá sấu chào bạn thỏ! Tớ đang tắm nắng trên bãi cỏ ven bờ suối nè!',
      'Dưới suối có rất nhiều cá lội mương bơi lượn theo dòng chảy, bạn nhìn thấy không?',
      'Thỉnh thoảng mấy chú cá chép còn nhảy vọt lên khỏi mặt nước làm bắn tung tóe nữa đấy!',
    ],
    dialogueTimer: 0,
  });
